...
def atletas(request):
    lista_jogadoras = [
        {"nome": "Ana Cristina Souza", "idade": 20, "local_nascimento": "Santo André, SP", "posicao": "Ponteira", "foto":"imgs/Anacris.jpg"},
        ...
        {"nome": "Ana Carolina", "idade": 33, "local_nascimento": "Belo Horizonte, MG", "posicao": "Central", "foto":"imgs/Anac.jpg"},
